...
struct gengetopt_args_info
{
  ...
  int input_flag;	/**< @brief Read from input registers not holding (default=off).  */
  const char *input_help; /**< @brief Read from input registers not holding help description.  */
  int swap_flag;	/**< @brief Swap two 16 bits in (u)int32 (default=off).  */
  const char *swap_help; /**< @brief Swap two 16 bits in (u)int32 help description.  */
